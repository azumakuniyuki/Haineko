...
Haineko::RFC5322 - Tools related RFC-5322

=head1 SYNOPSIS

    use Haineko::RFC5322;
    my $x = Haineko::RF5322->is_emailaddress( 'kijitora@example.jp' );
    my $y = Haineko::RFC5322->is_domainpart( 'example.jp' ):
...
is_emailaddress() checks whether the argument is valid email address or not.
    ...
    print Haineko::RFC5322->is_emailaddress( $x );  # 0
    print Haineko::RFC5322->is_emailaddress( $y );  # 1
    print Haineko::RFC5322->is_emailaddress( $z );  # 0

=head2 B<is_domainpart( I<Domain part>) >

is_domainpart() returns checks the argument is valid domain part or not.

    print Haineko::RFC5322->is_domainpart( 'kijitora' );    # 0
    print Haineko::RFC5322->is_domainpart( 'example.jp.' ); # 1
    print Haineko::RFC5322->is_domainpart( '' );        # 0
